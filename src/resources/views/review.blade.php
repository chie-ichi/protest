                            ...
                            <div class="review-form__item">
                                ...
                                <div class="upload-area" id="uploadArea">
                                    <div class="upload-area__txt-wrap">
                                        ...
                                        <p class="upload-area__filename" id="fileName"></p>
                                    </div>
                                    <input type="file" id="fileInput" name="photo_file" class="review-form__file">
                                </div>
                                <img id="preview" src="" alt="プレビュー画像" style="display: none; width: 100%; max-width: 300px;" class="review-form__dropzone-preview">
                            </div>
                        </div>
                    </div>
